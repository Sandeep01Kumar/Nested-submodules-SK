...
// EXPRESSION (not a top-level `function multiply` declaration) so the browser
// C-002 bridge — which loads these files as classic <script>s — does not also
// leak a stray `window.multiply` global (F-SEC-01 namespace pollution). A named
...
module.exports = function multiply(a,b){
    ...
    // non-finite value (e.g. multiply(Number.MAX_VALUE, 2) === Infinity).
